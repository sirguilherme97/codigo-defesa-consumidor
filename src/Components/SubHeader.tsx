...
export function SubHeader({isDarkMode}:any) {
    ...
    return (
        <div className='w-screen h-auto flex flex-col items-center justify-around px-8'>
            ...
            <Popover>
                ...
                <Popover.Panel>
                    <ul className="grid grid-cols-3 px-8 py-4 sm:gap-2 gap-6 sm:flex flex-col ">
                        <li><a
                            target="_blank"
                            className={classNames("text-md font-normal underline underline-offset-1  hover:text-rep hover:font-medium transition-all",{
                                'text-zinc-50':isDarkMode,
                                'text-zinc-600':!isDarkMode
                            })}
            ...
            <p className={classNames("leading-relaxed",{
                'text-zinc-50':isDarkMode,
                'text-zinc-700':!isDarkMode
            })}>Dispõe sobre a proteção do consumidor e dá outras providências.</p>
            <p className={classNames("leading-relaxed",{
                'text-zinc-50':isDarkMode,
                'text-zinc-700':!isDarkMode
            })}><strong>O PRESIDENTE DA REPÚBLICA</strong>, faço saber que o Congresso Nacional decreta e eu sanciono a seguinte lei:</p>
        </div>
    )
}
